ig.module(
	'game.entities.rusherBlue'
	)
.requires(
	'game.entities.rusherGreen'
	)
.defines(function () {
    EntityRusherBlue = EntityRusherGreen.extend({
collides: ig.Entity.COLLIDES.NONE,
        ...
        init: function (x, y, settings) {
            ...
            this.animSheet = new ig.AnimationSheet('media/Enemies/RusherBlue.png', 32, 32);
        ...
        kill: function () {
            this.parent();
            ig.game.player.killEvents.rusherBlueKills += 1; ig.game.player.killEvents.rusherGreenKills -= 1;
            ig.game.spawnEntity(EntityDeathExplosion, this.pos.x, this.pos.y, { colorOffset: 9 });
        }
		
    });

    ig.EntityPool.enableFor(EntityRusherBlue);
});