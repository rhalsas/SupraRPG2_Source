...
.defines(function(){
		EntityOrangegoblin = EntityGoblin.extend({
		    ...
		    kill: function () {
		    this.parent();
		    ig.game.player.killEvents.speedpurple_zombieKills += 1; ig.game.player.killEvents.green_zombieKills -= 1;
		    ig.game.spawnEntity(EntityDeathExplosion, this.pos.x, this.pos.y, { colorOffset: 1 });
		        //ig.game.EndScreen();
		    },
				
		});
		ig.EntityPool.enableFor(EntityOrangegoblin);
