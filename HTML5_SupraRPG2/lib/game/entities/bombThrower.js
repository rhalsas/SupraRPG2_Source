ig.module(
	'game.entities.bombThrower'
	)
.requires(
	'game.entities.redMage'
	)
.defines(function(){
		EntityBombThrower = EntityRedMage.extend({
			...
			init: function(x,y,settings){
				...
				this.animSheet = new ig.AnimationSheet('media/Enemies/BombThrower.png',32, 32);
		    ...
		    kill: function () {
		    this.parent();
		    ig.game.player.killEvents.bombThrowerKills += 1; ig.game.player.killEvents.red_wizardKills -= 1;
		    ig.game.spawnEntity(EntityDeathExplosion, this.pos.x, this.pos.y, { colorOffset: 1 });
		    }
		});
		ig.EntityPool.enableFor(EntityBombThrower);
