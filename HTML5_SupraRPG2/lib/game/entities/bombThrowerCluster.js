ig.module(
	'game.entities.bombThrowerCluster'
	)
.requires(
	'game.entities.redMage'
	)
.defines(function(){
		EntityBombThrowerCluster = EntityRedMage.extend({
			...
			init: function(x,y,settings){
				...
				this.animSheet = new ig.AnimationSheet('media/Enemies/BombThrowerCluster.png',32, 32);
		...
		ig.EntityPool.enableFor(EntityBombThrowerCluster);
