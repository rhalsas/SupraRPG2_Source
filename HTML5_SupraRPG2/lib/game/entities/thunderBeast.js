ig.module(
	'game.entities.thunderBeast'
	)
.requires(
	'game.entities.redMage'
	)
.defines(function () {
    EntityThunderBeast = EntityRedMage.extend({
        ...
        init: function (x, y, settings) {
            ...
            this.animSheet = new ig.AnimationSheet('media/Enemies/ThunderBeast.png', 32, 32);
            ...
            this.CurrentSpell = 'EntityThunderSpell_E';
            this.EXP_BOUNTY = 120;
