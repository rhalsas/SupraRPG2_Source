ig.module(
	'game.entities.bombThrowerStrong'
	)
.requires(
	'game.entities.redMage'
	)
.defines(function(){
		EntityBombThrowerStrong = EntityRedMage.extend({
			...
			init: function(x,y,settings){
				...
				this.animSheet = new ig.AnimationSheet('media/Enemies/BombThrowerStrong.png',32, 32);
		    ...
		    kill: function () {
		    this.parent();
		    ig.game.player.killEvents.bombThrowerStrongKills += 1; ig.game.player.killEvents.red_wizardKills -= 1;
		    ig.game.spawnEntity(EntityDeathExplosion, this.pos.x, this.pos.y, { colorOffset: 1 });
		    }
		});
		ig.EntityPool.enableFor(EntityBombThrowerStrong);
