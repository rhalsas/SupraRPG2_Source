ig.module(
	'game.entities.bombThrowerWeak'
	)
.requires(
	'game.entities.redMage'
	)
.defines(function(){
		EntityBombThrowerWeak = EntityRedMage.extend({
			...
			init: function(x,y,settings){
				...
				this.animSheet = new ig.AnimationSheet('media/Enemies/BombThrowerWeak.png',32, 32);
				...
				this.CurrentSpell = 'EntityBombThrow_1_E';
				this.EXP_BOUNTY = 17;
		...
		ig.EntityPool.enableFor(EntityBombThrowerWeak);
